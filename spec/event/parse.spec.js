...
describe('parse', () => {
  ...
  beforeEach(() => {
    ...
    eventWithoutApplicationId = JSON.parse(
      readFileSync('spec/event/event_without_application_id.json')
    );
    eventWithoutApprovalDate = JSON.parse(
      readFileSync('spec/event/event_without_approval_date.json')
    );
  });
